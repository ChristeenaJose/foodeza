/** Mittagessen / Corporate Lunch — Kassa */
window.FOODEZA_MENU = [
  ...
  { id: 'lassi', menuGroup: 'Corporate Lunch', category: 'Getränke', name: 'Mango Lassi', priceCents: 300, active: true },
  { id: 'lemonade', menuGroup: 'Corporate Lunch', category: 'Getränke', name: 'Super Cool Lemonade', priceCents: 250, active: true },
];

window.POS_MENU_GROUP_ORDER = ['Corporate Lunch'];
window.POS_CATEGORY_ORDER = {
  'Corporate Lunch': ['Curry Bowl', 'Getränke'],
};
